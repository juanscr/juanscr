...
- Creating virtual machines with QEMU with PCIe passthrough.
- Modifying Ligate hardware color configuration and button setup.
- And more! (see the table of contents to see the full changes.)

* Table of Contents :toc:
- [[#logitech-customization][Logitech Customization]]
